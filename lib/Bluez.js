	...
	async onPropertiesChanged(path, properties) {
		...
		switch (path) {
			case 'org.bluez.MediaPlayer1' : {
				this.emit('MediaPlayer', properties);
				break;
			}
			...
			case 'org.bluez.Device1' : {
				this.emit('Device', properties);
				break;
			}

			case 'org.bluez.Network1' : {
				this.emit('Network', properties);
				break;
			}

			case 'org.bluez.MediaControl1' : {
				this.emit('MediaControl', properties);
				break;
			}

			case 'org.bluez.MediaTransport1' : {
				this.emit('MediaTransport', properties);
				break;
			}

			case 'org.bluez.Filesystem1' : {
				this.emit('Filesystem', properties);
				break;
			}

			case 'org.bluez.MediaItem1' : {
				this.emit('MediaItem', properties);
				break;
			}
		}
	}
