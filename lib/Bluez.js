...
class Bluez extends EventEmitter {
	...
	async getAdapter(dev) {
		...
		this.properties.Adapter[path] = await this.getInterface('org.bluez', this.interfaces.Adapter[path], 'org.freedesktop.DBus.Properties');
		this.properties.Adapter[path].on('PropertiesChanged', this.onPropertiesChanged.bind(this));
